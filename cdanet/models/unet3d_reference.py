"""
3D U-Net implementation based on reference sourcecodeCDAnet architecture.
This matches the exact architecture used in the original training.
"""
import math
import numpy as np
import torch
...
class inceptionRes3D(nn.Module):
    """3D convolutional Inception Residual Block. Maintains same resolution."""
...
class UNet3d(nn.Module):
    ...
    def __init__(self, in_features=4, out_features=32, igres=(4, 32, 32), ogres=None, nf=16, mf=512):
        """initialize 3D UNet.
    ...
    def _create_layers(self):
        ...
        # Use Inception blocks as in reference
